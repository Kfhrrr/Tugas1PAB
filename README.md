...
pada halaman ini memuat produk dan informasi dari produk tersebut seperti tampilan produk, nama produk, dan harga produk yang dapat dilihat pada beberapa gambar dibawah ini.
...
Pada halaman ini juga terdapat fitur search product berdasarkan nama produk yang tampilannya berupa kolom inputan dengan emoji atau logo kaca pembesar bertuliskan "Search Product". Pengguna dapat menuliskan nama produk yang dicari pada kolom inputan tersebut.
...
Selain fitur search by nama product, terdapat juga fitur filter by categories dengan bentuk dropdown yang saat di klik akan memunculkan beberapa kategori produk, yaitu all untuk semua kategori product, electronics, dan juga accessories.
...
### D. Add to Cart
Terdapat fitur add to chart pada kolom produk yang saat di klik akan otomoatis menambahkan produk yang dipilih ke dalam cart/keranjang.

<img width="957" height="1018" alt="image" src="https://github.com/user-attachments/assets/d9c49412-251b-45c5-af7c-4a88796769ac" />

### E. Go to Cart Page
Untuk melihat produk yang telah ditambahkan ke dalam keranjang, pengguna dapat mengklik button dengan logo keranjang yang letaknya ada di pojok kanan atas halaman.
...
Setelah mengklik button dengan logo keranjang, pengguna akan langsung berpindah ke cart page, pada halaman ini berisi informasi produk apa saja yang berada dalam keranjang beserta nama, harga sartuan produk, jumlah, dan harga keseluruhan produk dalam keranjang. Terdapat juga beberapa fitur, yaitu menambah dan mengurangi jumlah produk, menghapus produk, dan button untuk melakukan checkout produk.

<img width="957" height="1020" alt="image" src="https://github.com/user-attachments/assets/42491687-f92d-4dfe-8b22-ac6b8cb1d759" />

### G. Menambah dan Mengurangi Jumlah Produk
Untuk fitur tambah jumlah produk, terdapat button dengan logo ( + ) yang saat ditekan akan menambahkan jumlah produk dan untuk fitur kurangi jumlah produk, terdapat button dengan logo ( - ) yang saat ditekan akan mengurangi jumlah produk di keranjang.
...
Untuk menghapus salah satu produk, terdapat icon tong sampah berwarna merah disetiap kolom produk. Pengguna dapat menekan icon tersebut sesuai dengan produk mana yang ingin dihapus.

<img width="959" height="1016" alt="image" src="https://github.com/user-attachments/assets/a2494272-c8b9-4a54-8691-59d5649723e0" />

Setelah ditekan produk akan langsung terhapus dari keranjang seperti pada gambar di bawah.
...
Untuk langsung menghapus selurh produk yang ada dikeranjang, terdapat icon button tong sampah berwarna abu-abu pada bagian pojok kanan atas halaman.

<img width="958" height="1019" alt="image" src="https://github.com/user-attachments/assets/3b206ae9-ee67-497c-9b63-5ef472ca951f" />

Saat icon button itu ditekan akan muncul message "Clear Cart?" sebagai message validasi apakah pengguna benar ingin menghapus seluruh produk yang ada di keranjang, saat pengguna memilih opsi "Cancel" maka penghapusan akan dibatalkan, dan jika memilih opsi "Clear" maka seluruh produk yang ada pada keranjang akan langsung terhapus.

<img width="955" height="1017" alt="image" src="https://github.com/user-attachments/assets/f877a0ce-c033-4c87-9264-9c266dab76c6" />

Di bawah ini adalah tampilan saat seluruh produk dalam keranjang telah berhasil dihapus
...
Jika pengguna telah mengonfirmasi produk yang akan dibeli, terdapat button "Checkout" pada bagian pojok kanan bawah halaman untuk melanjutkan proses pembelian.
...
Setelah menekan button "Checkout" pada halaman keranjang, pengguna akan berpindah ke halaman checout/checkout page. pada halaman ini terdapat informasi jumlah order yang memuat nama produk, quantity/jumlah produk, harga produk dan juga harga total dari keseluruhan produk.

<img width="958" height="805" alt="image" src="https://github.com/user-attachments/assets/05e6c28c-c753-4f74-b176-f90b2a23bed7" />

Terdapat juga form informasi kustomer yang berisi nama pemesan, nomor hp, dan alamat si pemesan. Pengguna dapat mengisi form tersebut untuk melakukan order produk.

<img width="956" height="692" alt="image" src="https://github.com/user-attachments/assets/58caadbe-aa9b-46d9-9851-0e2d26a658e4" />

Di bawah form informasi kustomer terdapat payment method, pengguna dapat memilih 2 metode pembayaran produk, yaitu COD dan via Transfer. Terdapat juga kolom "notes" sebagai kolom untuk menyampaikan pesan dari pembeli kepada penjual yang bersifat opsional. Setelah mengkonfirmasi seluruh data pemesanan, pengguna dapat menekan button "Place Order".
...
Setelah menekan button "Place Order" maka akan muncul tampilan seperti dibawah ini, terdapat message "Order Placed Successfully" yang menandakan bahwa proses checkout berhasil.
